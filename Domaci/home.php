...
<div id="pregled" class="panel panel-success" style="margin-top: 1%;">
    ...
    <div class="panel-body">
        <table id="myTable" class="table table-hover table-striped" style="color: black; background-color: grey;" >
            ...
            ?>
                <tr>
                    <td name="predmet"><?php echo $red["predmet"] ?></td>
                    <td name="katedra"><?php echo $red["katedra"] ?></td>
                    <td id="sala"><?php echo $red["sala"] ?></td>
                    <td><?php echo $red["datum"] ?></td>
                    <td>
                        <label class="custom-radio-btn">
                            <input type="radio" name="checked-donut" id="radio" value=<?php echo $red["id"] ?>>
                ...
                <div class="container prijava-form">
                    <form action="#" method="post" id="izmeniForm">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input id="id1" type="text" name="id" class="form-control"
                                           placeholder="Id *"
                                            value=""
                                            readonly />
                                </div>
                                <div class="form-group">
                                    <input id="predmet1" type="text" name="predmet" class="form-control"
                                           placeholder="Predmet*" value=""/>
                                </div>
                                <div class="form-group">
                                    <input id="katedra1" type="text" name="katedra" class="form-control"
                                           placeholder="Katedra *" value=""/>
                                </div>
                                <div class="form-group">
                                    <input id="sala1" type="text" name="sala" class="form-control"
                                           placeholder="Sala *" value=""/>
                                </div>
                                <div class="form-group">
                                    <input id="datum1" type="date" name="datum" class="form-control"
